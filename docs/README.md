...
-   Virtualization: qemu, cockpit, virtualbox
...
-   Management: Flatseal(for flatpaks), Gear Lever(for appimages), Flatsweep (clean up leftover flatpak files), Warehouse (for flatpaks)
